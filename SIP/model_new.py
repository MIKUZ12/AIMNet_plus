...
class Net(nn.Module):
    ...
    def forward(self, x_list,mask):
        ...
        z_sample, uniview_mu_list, uniview_sca_list, fusion_z_mu, fusion_z_sca, xr_list, xr_s_list, xr_p_list, pos_beat_I = self.VAE(x_list,mask)  #Z[i]=[128, 260, 512] b c d_e
        ...
        return z_sample, uniview_mu_list, uniview_sca_list, fusion_z_mu, fusion_z_sca, xr_list, label_embedding_sample,p, label_embedding, label_embedding_var, None, xr_s_list, xr_p_list, pos_beat_I
